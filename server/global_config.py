...
class GlobalConfig:
    ...
    def _quick_access_hide(self):
        key = "MEMLOG_QUICK_ACCESS_HIDE"
        value = get_env(key, mandatory=False, default=False, cast_bool=True)
        if value is False:
            depricated_key = "MEMLOG_HIDE_RECENTLY_MODIFIED"
            value = get_env(
